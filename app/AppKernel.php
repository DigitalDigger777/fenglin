...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = [
            ...
            new Panda\ShopperBundle\PandaShopperBundle(),
            new Panda\ConsumerBundle\PandaConsumerBundle(),
            new Fenglin\CashBackBundle\FenglinCashBackBundle(),
            new Fenglin\FenglinBundle\FenglinFenglinBundle(),
